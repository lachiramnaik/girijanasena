...
import Shamsunder from '../../images/team/shamsundar.jpeg'
import Babunaik from '../../images/team/babu.jpg'
    ...
    <>
      ...
      <SectionFour>
        ...
        <SectionFourCard>
          <StyledRow>
            ...
            <StyledCol md={3}>
              <CardImage> <img src={Sevalal} alt='' className='achivements-image'></img></CardImage>
            </StyledCol>
      ...
      <SectionFive>
        ...
        <SectionFourCard className='sectionfivecard'>
          <StyledRow>
            <StyledCol md={3}>
              <CardImage> <img src={Komaram} alt='' className='achivements-image'></img></CardImage>
            </StyledCol>
            <StyledCol md={9}>
              <CardOneContent>
      ...
      <SectionFour>
        <SectionFourCard>
          <StyledRow>
            ...
            <StyledCol md={3}>
              <CardImage> <img src={Birsa} alt='' className='achivements-image'></img></CardImage>
            </StyledCol>

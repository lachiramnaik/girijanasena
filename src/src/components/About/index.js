...
import { Container, StyledRow, StyledCol, MainCard, MainImage, Overlay, MainText, CardTwo, CardOneContent,CardImage,CardOne,CardOneSection } from './styles'
const About = () => {
  return (
    <>
      <Container>
...
<CardImage> <img src={Img1} alt='' className='image'></img></CardImage>
       ...
       <StyledCol md={8}>
         <CardOneContent>
		RSP Girijanasena Sena
To resolve Girijanasena issues in Telangana state,
RSP Girijanasena sena will help for education, health, employment, political growth of 
Tribal to do many programs under the auspices.
The organization formed with the leaders is the RSP Girijanasena Sena.
...
RSP Girijanasena sena will work.
       </CardOneContent>
       </StyledCol>
     </StyledRow>
	 </CardOneSection>
